...
export const createStudentValidation = z.object({
  ...
  email: z
    .string({ message: 'Email is required to register a student.' })
    .email('Invalid email format. Please enter a valid email address.'),
  contactNo: z
    .string()
    .min(
  ...
  designation: z.string({
    message: 'Designation is required to register a student.',
  }),
  academicDepartment: z.string({
    message: 'Academic department is required to register a student.',
  }),
...
export type StudentFormData = z.infer<typeof createStudentValidation>;